Rails.application.routes.draw do  
  ...
  # get("/zodiacs/:sign", { :controller =>  "fire", :action =>  "ram" })
  ...
  get("/roll/:number_of_die/:number_of_sides", { :controller => "dice", :action => "infinity_and_beyond" })

  get("zodiacs/:sign", :controller =>"fire", :action =>"all_known")
end 
